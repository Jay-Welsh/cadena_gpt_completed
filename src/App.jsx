...
const App = () => {
  ...
  const handleButtonClick = (type, predefinedPrompt) => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (buttonType === "humorous") {
      finalPrompt += " #Funny #Comedy #Entertainment";
    } else if (buttonType === "serious") {
      finalPrompt += " #Business #Professional #Insights";
    }
  ...
  return (
    <div className="flex flex-col items-center justify-center px-4 sm:p-0">
      ...
      <div>
        <button onClick={() => handleButtonClick("humorous", "Make a humorous LinkedIn Post about:")}>Humorous</button>
        <button onClick={() => handleButtonClick("serious", "Create a serious LinkedIn Post discussing:")}>Serious</button>
      </div>
